                ...
                <div style={styles.body}>
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <i className="bi bi-person-circle" style={{ marginRight: '8px', color: '#2a9d8f' }}></i>
                        ...
                        <div style={{
                            ...
                            <div>
                                <span style={{ fontWeight: '600', color: '#495057' }}>Teléfono:</span>
                                <div style={{ color: '#333', marginTop: '2px' }}>
                            ...
                            <div style={{ gridColumn: 'span 2' }}>
                                <span style={{ fontWeight: '600', color: '#495057' }}>ID Cliente:</span>
                                <div style={{ color: '#6c757d', marginTop: '2px', fontFamily: 'monospace', fontSize: '12px' }}>
                                    {client?._id || 'No disponible'}
                                </div>
                            </div>
                        </div>
                    </div>
